...
type Agent struct {
	...
	// TODO: probably change this to interface
...
// applySetPair is a helper method to be called when
...
func (a *Agent) applySetPair(pair *types.Pair) error {
	...
	// TODO: here we can check the response
